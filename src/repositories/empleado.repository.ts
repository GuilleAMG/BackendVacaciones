...
> {
  ...
  constructor(
    @inject('datasources.ConnAtlas') dataSource: ConnAtlasDataSource, @repository.getter('CargoRepository') protected cargoRepositoryGetter: Getter<CargoRepository>, @repository.getter('VacacionesRepository') protected vacacionesRepositoryGetter: Getter<VacacionesRepository>,
  ) {
